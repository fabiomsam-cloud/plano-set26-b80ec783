...
const CAMPANHAS_PLANO: { id: string; conta: string; ec?: string }[] = [
  ...
  { id: "120256497258620492", conta: "SCVP ON-LINE" },    // [PLANO][LIVE][PRF] convite da Super Aula PRF 2027 → trilha (ativa 22/09, Alcance)
  { id: "120256498556050492", conta: "SCVP ON-LINE" },    // [PLANO][LIVE][POLICIAS] lembrete da Sala Secreta 28/09 → trilha (ativa 22/09, Alcance)
